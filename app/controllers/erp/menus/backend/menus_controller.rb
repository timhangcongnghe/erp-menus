    ...
    module Backend
      class MenusController < Erp::Backend::BackendController
        ...
        private
          ...
          def menu_params
            params.fetch(:menu, {}).permit(:image_url_1, :image_url_2, :name, :description, :parent_id, :menu_type, :style_icon,
                                           :meta_keywords, :meta_description, :style_color, :image_menu_link_1, :image_menu_link_2, :menu_icon, :brand_group_id, category_ids: [],
